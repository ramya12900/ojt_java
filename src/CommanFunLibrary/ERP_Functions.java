...
System.setProperty("webdriver.chrome.driver","D:\\Selenium_Evening\\ERP_Stock\\CommonDriver\\chromedriver.exe");
	...
	{
		res="Application Launched Sucessfull";
	}
	else
	{
		res="Application Launched Fail"	;
	}
	return res;
}
//login method 
...
throws Throwable{
	...
	WebElement objpas=driver.findElement(By.name("password"));
	objpas.clear();
	Thread.sleep(3000);
	objpas.sendKeys(password);
	Thread.sleep(3000);
...
public static void verifylogout()
{
   ...
   //method to create supplier method
public static String verifySuppiler(String sname,String saddress,String city,String country,String cperson,String pnumber,String email,String mnumber,String notes)throws Throwable
{
	String res="";
	...
	driver.findElement(By.name("x_Address")).sendKeys(saddress);
...
String Act_data=driver.findElement(By.xpath("//table[@id='tbl_a_supplierslist']/tbody/tr/td[6]/div/span/span")).getText();
Thread.sleep(2000);
